...
chromium=(COLON_1, H508_EV H508_LSD1_KD HT29_EV HT29_LSD1_KD)
ncores=8
...
#  qsub -v SAMPLE=${sample},NCORES=${ncores} -l nodes=1:ppn=8,vmem=120gb,walltime=48:00:00 velocyto_microwell.sh
#done
